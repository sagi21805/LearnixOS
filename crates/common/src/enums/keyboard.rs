...
impl const From<u8> for PS2ScanCode {
    fn from(value: u8) -> Self {
        match value {
            ...
            0x4B => PS2ScanCode::LeftArrow,
            0xCB => PS2ScanCode::ReleasedLeftArrow,
            0x4C => PS2ScanCode::Keypad5,
            0xCC => PS2ScanCode::ReleasedKeypad5,
            0x4D => PS2ScanCode::RightArrow,
            0xCD => PS2ScanCode::ReleasedRightArrow,
...
impl PS2ScanCode {
    ...
    pub fn to_str_shifted(&self) -> &'static str {
        match self {
            ...
            PS2ScanCode::LeftArrow => "Keypad 4",
            PS2ScanCode::Keypad5 => "Keypad 5",
            PS2ScanCode::RightArrow => "Keypad 6",
