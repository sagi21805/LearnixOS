...
pub extern "x86-interrupt" fn keyboard_handler(_stack_frame: InterruptStackFrame) {
    unsafe {
        ...
        match PS2ScanCode::from_scancode(scan_code) {
            ...
            PS2ScanCode::ReleasedLeftShift => keyboard.flags.unset_lshift_pressed(),
            PS2ScanCode::RightShift => keyboard.flags.set_rshift_pressed(),
            PS2ScanCode::ReleasedRightShift => keyboard.flags.unset_rshift_pressed(),
            PS2ScanCode::LeftCtrl => keyboard.flags.set_lctrl_pressed(),
            PS2ScanCode::ReleasedLeftCtrl => keyboard.flags.unset_lctrl_pressed(),
            PS2ScanCode::SuperKey => keyboard.flags.set_superkey_pressed(),
            PS2ScanCode::ReleasedSuperKey => keyboard.flags.unset_superkey_pressed(),
